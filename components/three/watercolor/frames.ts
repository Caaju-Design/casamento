...
export const CAFE_SOL_FRAMES = single("/historia/cafe/sol", 3 / 4);
export const CAFE_NOITE_FRAMES = single("/historia/cafe/noite", 9 / 16);
export const CAFE_SHOW_FRAMES = single("/historia/cafe/show", 3 / 4);
