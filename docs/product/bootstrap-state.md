...
- Repositório: `git@github.com:Caaju-Design/casamento.git` — **público** (decisão do casal, feita direto no GitHub/Vercel, não pelo agente); histórico do git verificado, nenhum segredo jamais foi commitado.
